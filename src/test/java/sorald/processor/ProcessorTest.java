...
public class ProcessorTest {
   ...
   * directory in {@link ProcessorTestHelper#TEST_FILES_ROOT}. To add a new test for a rule without
   * existing tests, add a new directory+Java file in {@link ProcessorTestHelper#TEST_FILES_ROOT} as
   * described in the docs for {@link ProcessorTestHelper#toProcessorTestCase(File)}.
   */
  @ParameterizedTest
  @ArgumentsSource(NonCompliantJavaFileProvider.class)
  public void testProcessSingleFile(
      ProcessorTestHelper.ProcessorTestCase<? extends JavaFileScanner> testCase) throws Exception {
