...
public class Main {
    ...
    public JSAP defineArgs() throws JSAPException {
        ...
        opt.setStringParser(
                FileStringParser.getParser().setMustExist(true).setMustBeDirectory(true));
    ...
    public void initConfig(JSAPResult arguments) {
        ...
        if (arguments.getFile(Constants.ARG_GIT_REPO_PATH) != null) {
            this.getConfig()
                    .setGitRepoPath(
                            arguments.getFile(Constants.ARG_GIT_REPO_PATH).getAbsolutePath());
        }
        this.getConfig()
        ...
        this.getConfig()
                .setFileOutputStrategy(
                        FileOutputStrategy.valueOf(
                                arguments.getString(Constants.ARG_FILE_OUTPUT_STRATEGY)));
