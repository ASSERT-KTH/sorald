...
public class Processors {
	...
	private static final Map<Integer, Class<? extends SoraldAbstractProcessor>> RULE_KEY_TO_PROCESSOR = init();

	private static Map init() {
		Map<Integer, Class<? extends SoraldAbstractProcessor>> TEMP_RULE_KEY_TO_PROCESSOR = new HashMap<>();
		Reflections reflections = new Reflections(Constants.PROCESSOR_PACKAGE);
		Set<Class<? extends SoraldAbstractProcessor>> allProcessors = reflections.getSubTypesOf(SoraldAbstractProcessor.class);
