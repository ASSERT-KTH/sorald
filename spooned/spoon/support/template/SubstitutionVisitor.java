...
public class SubstitutionVisitor extends CtScanner {
    ...
    private SubstitutionVisitor.Context context;
    ...
    private class InheritanceSustitutionScanner extends CtInheritanceScanner {
        ...
        public void scanCtNamedElement(CtNamedElement element) {
            ...
            if (value != null) {
                ...
                // this named element has to be replaced by zero one or more other elements
                    ...
                    if ((value instanceof CtTypeReference) && (element instanceof CtType)) {
        ...
        public void scanCtReference(CtReference reference) {
            ...
            if (value != null) {
                if (reference instanceof CtTypeReference) {
                    ...
                    CtTypeReference<?> tr = SubstitutionVisitor.getParameterValueAsTypeReference(factory, value);
        ...
        public void visitCtForEach(CtForEach foreach) {
            if ((foreach.getExpression()) instanceof CtFieldAccess) {
                ...
                if (value != null) {
                    ...
                    SubstitutionVisitor.Context localContext = createContext();
            ...
            if (v != null) {
                ...
                if (!(value instanceof TemplateParameter)) {
                    ...
                    if (value instanceof Class) {
                        throw context.replace(toReplace, factory.Code().createClassAccess(factory.Type().createReference(((Class<?>) (value)).getName())));
                    }/* If the value is type String, then it is ambiguous request, because:
                    A) sometime client wants to replace parameter field access by String literal
                    ...
                    // so do nothing here. The string substitution is handled by #scanCtReference
                        ...
                        if (value instanceof Enum) {
                            ...
                            CtFieldRead<?> enumValueAccess = ((CtFieldRead<?>) (factory.Code().createVariableRead(factory.Field().createReference(enumType, enumType, ((Enum<?>) (value)).name()), true)));
                            ...
                            if ((value != null) && (value.getClass().isArray())) {
                                ...
                                if ((fieldAccess == toReplace) && (value instanceof String)) {
                                }else {
        ...
        public <T> void visitCtInvocation(CtInvocation<T> invocation) {
            if (invocation.getExecutable().isOverriding(S)) {
                ...
                if (((invocation.getTarget()) instanceof CtArrayAccess) && ((((CtArrayAccess<?, CtExpression<?>>) (invocation.getTarget())).getTarget()) instanceof CtFieldAccess)) {
                ...
                if ((fa != null) && (((fa.getTarget()) == null) || ((fa.getTarget()) instanceof CtThisAccess))) {
                    CtCodeElement r = getParameterValueAtIndex(CtCodeElement.class, context.getParameterValue(fa.getVariable().getSimpleName()), Parameters.getIndex(fa));
    ...
    private SubstitutionVisitor.InheritanceSustitutionScanner inheritanceScanner;
    ...
    public SubstitutionVisitor(Factory f, Map<String, Object> templateParameters) {
        this.inheritanceScanner = new SubstitutionVisitor.InheritanceSustitutionScanner();
        this.factory = f;
        S = factory.Executable().createReference(factory.Type().createReference(TemplateParameter.class), factory.Type().createTypeParameterReference("T"), "S");
        this.context = new SubstitutionVisitor.Context(null).putParameters(templateParameters);
    }
    ...
    public <E extends CtElement> List<E> substitute(E element) {
        ...
        if (addGeneratedBy) {
            ...
            final CtInheritanceScanner internalScanner = new CtInheritanceScanner() {
                public void scanCtTypeMember(CtTypeMember typeMeber) {
                    elementToGeneratedByComment.put(typeMeber, SubstitutionVisitor.getGeneratedByComment(typeMeber));
                }
            };
            new CtScanner() {
                @Override
        ...
        if (addGeneratedBy) {
            ...
            SubstitutionVisitor.applyGeneratedByComments(elementToGeneratedByComment);
        }
        return result;
    }
        ...
        if (pos != null) {
            ...
            if (cu != null) {
                ...
                if (mainType != null) {
                    ...
                    SubstitutionVisitor.appendInnerTypedElements(result, mainType, ele);
                    result.append('(');
    ...
    private static void appendInnerTypedElements(StringBuilder result, CtType<?> mainType, CtElement ele) {
        CtTypeMember typeMember = SubstitutionVisitor.getFirst(ele, CtTypeMember.class);
        if ((typeMember != null) && (typeMember != mainType)) {
            if (typeMember.isParentInitialized()) {
                SubstitutionVisitor.appendInnerTypedElements(result, mainType, typeMember.getParent());
            }
    ...
    private static void applyGeneratedByComments(Map<CtElement, String> elementToGeneratedByComment) {
        for (Map.Entry<CtElement, String> e : elementToGeneratedByComment.entrySet()) {
            SubstitutionVisitor.addGeneratedByComment(e.getKey(), e.getValue());
        }
    }
    ...
    private static void addGeneratedByComment(CtElement ele, String generatedBy) {
        ...
        CtComment comment = SubstitutionVisitor.getJavaDoc(ele);
    ...
    private static CtComment getJavaDoc(CtElement ele) {
        ...
        CtComment c = ele.getFactory().Code().createComment("", JAVADOC);
        ele.addComment(c);
        return c;
    }
    ...
    private static <T extends CtElement> T getFirst(CtElement ele, Class<T> clazz) {
        if (ele != null) {
            ...
            if (ele.isParentInitialized()) {
                return SubstitutionVisitor.getFirst(ele.getParent(), clazz);
            }
        }
        return null;
    }
        ...
        if (parameterValue != null) {
            if (parameterValue instanceof Object[]) {
                ...
                if (parameterValue instanceof Iterable) {
                    ...
                    if ((parameterValue != null) && (parameterValue != (SubstitutionVisitor.NULL_VALUE))) {
    ...
    private String getParameterValueAsString(Object parameterValue) {
        ...
        if (parameterValue instanceof String) {
            ...
            if (parameterValue instanceof CtNamedElement) {
                return ((CtNamedElement) (parameterValue)).getSimpleName();
            }else
                if (parameterValue instanceof CtReference) {
                    ...
                    if (parameterValue instanceof Class) {
                        ...
                        if (parameterValue instanceof CtInvocation) {
                            return SubstitutionVisitor.getShortSignatureForJavadoc(((CtInvocation<?>) (parameterValue)).getExecutable());
                        }else
                            if (parameterValue instanceof CtExecutableReference) {
                                return SubstitutionVisitor.getShortSignatureForJavadoc(((CtExecutableReference<?>) (parameterValue)));
                            }else
                                if (parameterValue instanceof CtExecutable) {
                                    return SubstitutionVisitor.getShortSignatureForJavadoc(((CtExecutable<?>) (parameterValue)).getReference());
                                }else
                                    if (parameterValue instanceof CtLiteral) {
    ...
    private static <T> CtTypeReference<T> getParameterValueAsTypeReference(Factory factory, Object parameterValue) {
        ...
        if (parameterValue instanceof Class) {
            ...
            if (parameterValue instanceof CtTypeReference) {
                ...
                if (parameterValue instanceof CtType) {
    ...
    private SubstitutionVisitor.Context createContext() {
        // by default each new context has same input like parent and modifies same collection like parent context
        return new SubstitutionVisitor.Context(this.context);
    }

    private class Context {
        private final SubstitutionVisitor.Context parentContext;
        ...
        private Context(SubstitutionVisitor.Context parent) {
            this.parentContext = parent;
        }

        private SubstitutionVisitor.Context putParameter(String name, Object value) {
            if ((parameterNameToValue) == null) {
                parameterNameToValue = new LinkedHashMap<>();
            }
            if (value == null) {
                value = SubstitutionVisitor.NULL_VALUE;
            }
            parameterNameToValue.put(name, value);
            return this;
        }

        private SubstitutionVisitor.Context putParameters(Map<String, Object> parameters) {
        ...
        private <E extends CtElement> DoNotFurtherTemplateThisElement replace(CtElement toBeReplaced, List<E> replacements) {
            ...
            if (parentOfReplacement instanceof CtReturn) {
                ...
                if ((replacements.size()) > 1) {
                    ...
                    if (((replacements.size()) == 1) && (((replacements.get(0)) instanceof CtExpression) == false)) {
                        return context._replace(parentOfReplacement, replacements);
                    }
